...
it('can add the star name and star symbol properly', async() => {
    ...
    let tokenId = 6;
    let instance = await StarNotary.deployed();
    await instance.createStar('Udacity Star!', tokenId, {from: accounts[0]})
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Udacity Star!', tokenId2, {from: user2})
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let tokenId = 411;
    let instance = await StarNotary.deployed();
    await instance.createStar('Info Star', tokenId, {from: accounts[0]})
    // 2. Call your method lookUptokenIdToStarInfo
    let starName = await instance.lookUptokenIdToStarInfo.call(tokenId)
    // 3. Verify if you Star name is the same
    assert.equal(starName, "Info Star")
});